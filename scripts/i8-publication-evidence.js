...
const SCHEMA_VERSION = 'i8-s3a-signed-candidate-provenance-v2';
...
const EXACT_SOURCE_REF = 'refs/heads/codex/i8-s3a-ghcr-signed-candidate';
const EXACT_WORKFLOW = 'Candidate Publication - Signed GHCR (NO DEPLOY)';
const EXACT_WORKFLOW_PATH = '.github/workflows/candidate-publication.yml';
...
function validatePublication(value) {
    ...
    if (!allTrue(value, booleanKeys) || value.status !== 'published_attested_verified') {
