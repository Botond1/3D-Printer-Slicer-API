...
function validateRunbookSource(source) {
    ...
    for (const fragment of [
        ...
        '`2026-09-01 13:14:41`', 'host was reachable\nin about 40 seconds',
        '`r3d-perimeter.service` was both `active` and `enabled`',
        'reapplied the rules at boot', 'exactly three\nIPv4 rules plus one IPv6 rule',
        'both `healthy` at `t+5s`', 'prefix `sha256:153987840361...`',
        'HTTP 200 with valid\nTLS in 0.13 seconds',
        'IPv6 port 443 remained blocked; port 80 remained reachable',
