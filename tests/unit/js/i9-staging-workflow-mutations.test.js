...
const MUTATIONS = Object.freeze([
    ...
    ['post cleanup loses explicit container inspect status capture',
        '            if record="$(docker container inspect --format \\',
        '            record="$(docker container inspect --format \\'],
    ['post cleanup loses explicit network inspect status capture',
    ...
    ['evidence boundary restores stale digest key',
        '            previous_registry_digest: process.env.PREVIOUS_REGISTRY_DIGEST,',
        '            previous_digest: process.env.PREVIOUS_REGISTRY_DIGEST,'],
