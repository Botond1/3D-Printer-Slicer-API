...
function helperContract(source) {
    for (const anchor of [
        ...
        "profile.layer_gcode !== 'G92 E0'",
        "profile.use_relative_e_distances !== '0'",
...
test('Orca smoke weakening mutations are rejected by the local contract', async (t) => {
    const mutations = [
        ...
        ['extruder reset invariant removed', "profile.layer_gcode !== 'G92 E0'", 'false'],
        ['relative extrusion guard removed',
            "profile.use_relative_e_distances !== '0'", 'false'],
        ['runtime profile containment removed',
            "throw new Error('runtime_profile_escape')", 'return resolved'],
